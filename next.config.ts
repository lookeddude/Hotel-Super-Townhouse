...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://jzcmfpvscdsvkijpgdlj.supabase.co https://images.unsplash.com https://maps.gstatic.com https://maps.googleapis.com",
      "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://api.razorpay.com https://lumberjack.razorpay.com https://maps.googleapis.com",
      "frame-src https://api.razorpay.com https://checkout.razorpay.com https://www.google.com https://maps.google.com https://google.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
